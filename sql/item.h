...
public:
  ...
  enum Type {INVALID_ITEM= 0,
	     ...
	     FIELD_VARIANCE_ITEM, INSERT_VALUE_ITEM,
             ...
             VIEW_FIXER_ITEM,WINDOW_FUNC_ITEM,EXPR_CACHE_ITEM,
             DATE_ITEM};
...
public:
  ...
  */
  ...
  { return max_char_length() > CONVERT_IF_BIGGER_TO_BLOB; }//InfiniDB
...
public:
  ...
  bool idb_alias_name_used; // true if item was resolved against alias .InfiniDB
  /* 
...
public:
  ...
  /* Compare the cached value with the source value, without copying.InfiniDB */
